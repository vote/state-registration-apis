...
def test_simple():
    ...
    responses.add(
        responses.GET,
        STAGING_URL,
        match=[matchers.query_string_matcher(f"JSONv2&sysparm_AuthKey={api_key}&sysparm_action=GETERRORVALUES&sysparm_Language=0")],
    ...
    responses.add(
        responses.GET,
        STAGING_URL,
        match=[matchers.query_string_matcher(f"JSONv2&sysparm_AuthKey={api_key}&sysparm_action=GETAPPLICATIONSETUP&sysparm_Language=0")],
    ...
    responses.add(
        responses.GET,
        STAGING_URL,
        match=[matchers.query_string_matcher(f"JSONv2&sysparm_AuthKey={api_key}&sysparm_action=GETXMLTEMPLATE&sysparm_Language=0")],
...
def test_get_counties():
    ...
    responses.add(
        responses.GET,
        STAGING_URL,
        match=[matchers.query_string_matcher(f"JSONv2&sysparm_AuthKey={api_key}&sysparm_action=GETMUNICIPALITIES&sysparm_Language=0&sysparm_County=ADAMS")],
    ...
    responses.add(
        responses.GET,
        STAGING_URL,
        match=[matchers.query_string_matcher(f"JSONv2&sysparm_AuthKey={api_key}&sysparm_action=GETMUNICIPALITIES&sysparm_Language=0&sysparm_County=ALLEGHENY")],
